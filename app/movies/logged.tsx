...
export default function AllMovies() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const data = await getMediaLogsByType(user!.id, "movie", 200);
    ...
    return (
      <View className="flex-1 bg-background">
        <View className="px-5 mt-20 flex-row items-center mb-5">
          ...
          <Text className="text-white font-bold text-3xl">All Movies</Text>
        </View>
        <View className="flex-1 items-center justify-center px-5">
          ...
          <Text className="text-zinc-600 text-center text-sm mt-2">
            Start logging movies to see them here!
          </Text>
        </View>
      </View>
    );
