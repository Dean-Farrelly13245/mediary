...
export default function AllGames() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const data = await getMediaLogsByType(user!.id, "game", 200);
  ...
  if (loading) {
    return (
      <View className="flex-1 bg-background items-center justify-center">
        ...
        <Text className="text-white mt-4">Loading games...</Text>
      </View>
    );
  }
    ...
    return (
      <View className="flex-1 bg-background">
        <View className="px-5 mt-20 flex-row items-center mb-5">
          ...
          <Text className="text-white font-bold text-3xl">All Games</Text>
        </View>
        <View className="flex-1 items-center justify-center px-5">
          ...
          <Text className="text-zinc-600 text-center text-sm mt-2">
            Start logging games to see them here!
          </Text>
        </View>
      </View>
    );
